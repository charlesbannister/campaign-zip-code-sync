...
def _sync_campaign_criteria(campaign_ids: list[str], api_criteria_ids: list[str], campaign_criterion_ids_map: dict[str, dict[str, str]]) -> None:
    ...
    for campaign_id in campaign_ids:
        ...
        if criteria_to_add:
            campaign_criterion_mutator.add_location_criteria_to_campaign(campaign_id, criteria_to_add)
        ...
        if resource_names_to_remove:
            campaign_criterion_mutator.remove_location_criteria_from_campaign(campaign_id, resource_names_to_remove)
